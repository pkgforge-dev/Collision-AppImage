...
[![Latest Stable Release](https://img.shields.io/github/v/release/pkgforge-dev/Collision-AppImage)](https://github.com/pkgforge-dev/Collision-AppImage/releases/latest)
